...
public class SubsetTransformation extends AbstractTransformation {
	...
	public SubsetTransformation(Entity entity, JSONObject jsonObject, String projectName, Long executionTime) throws Exception {
	...
	private void init() throws Exception {
		try {
			...
			this.setSampling(params.has("sampling")?params.get("sampling").getTextValue():"Random_Sampling");
	...
	public String getInputArgsString() {
		...
		args.append(this.getPercentOfData()).append(";");
		args.append(this.getSampling());
