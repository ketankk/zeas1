...
angular.module("ui.bootstrap.transition", []).factory("$transition", ["$q", "$timeout", "$rootScope", function(e, t, n) {
    ...
    var r = function(i, s, o) {
        o = o || {};
        var u = e.defer();
        var a = r[o.animation ? "animationEndEventName" : "transitionEndEventName"];
        var f = function(e) {
            n.$apply(function() {
                i.unbind(a, f);
                u.resolve(i)
        ...
        link: function(t, n, r) {
            ...
            function u() {
                if (i) {
                    ...
                    n.removeClass("collapse").addClass("collapsing");
                    o({
...
angular.module("ui.bootstrap.accordion", ["ui.bootstrap.collapse"]).constant("accordionConfig", {
    ...
    this.removeGroup = function(e) {
        ...
        if (t !== -1) {
            this.groups.splice(this.groups.indexOf(e), 1)
        }
    }
...
angular.module("ui.bootstrap.buttons", []).constant("buttonConfig", {
    ...
    return {
        ...
        link: function(e, t, n, r) {
            function o() {
                return a(n.btnCheckboxTrue, true)
            }

            function u() {
                return a(n.btnCheckboxFalse, false)
            }
...
angular.module("ui.bootstrap.carousel", ["ui.bootstrap.transition"]).controller("CarouselController", ["$scope", "$timeout", "$transition", "$q", function(e, t, n, r) {
    ...
    i.select = function(r, u) {
        ...
        if (r && r !== i.currentSlide) {
            if (e.$currentTransition) {
                e.$currentTransition.cancel();
                t(c)
            } else {
                c()
            }
    ...
    i.addSlide = function(t, n) {
        t.$element = n;
        s.push(t);
        if (s.length === 1 || t.active) {
            i.select(s[s.length - 1]);
            if (s.length == 1) {
                e.play()
            }
        } else {
...
angular.module("ui.bootstrap.position", []).factory("$position", ["$document", "$window", function(e, t) {
    ...
    return {
        position: function(t) {
            ...
            var s = i(t[0]);
            if (s != e[0]) {
                r = this.offset(angular.element(s));
...
angular.module("ui.bootstrap.datepicker", ["ui.bootstrap.position"]).constant("datepickerConfig", {
        ...
        link: function(e, i, s, o) {
            ...
            function d(t) {
                var n = null,
                    i = true;
                if (a.$modelValue) {
                    n = new Date(a.$modelValue);
                    if (isNaN(n)) {
                        i = false;
                        r.error('Datepicker directive: "ng-model" value must be a Date object, a number of milliseconds since 01.01.1970 or a string representing an RFC2822 or ISO 8601 date.')
                    } else if (t) {
                        l = n
                    }
                }
            ...
            var f = 0,
                ...
                c = n.showWeeks;
            if (s.showWeeks) {
                e.$parent.$watch(t(s.showWeeks), function(e) {
                    c = !!e;
                    h()
                })
            } else {
            ...
            if (s.min) {
                e.$parent.$watch(t(s.min), function(e) {
                    u.minDate = e ? new Date(e) : null;
                    d()
                })
            }
            if (s.max) {
                e.$parent.$watch(t(s.max), function(e) {
    ...
    return {
        ...
        link: function(u, a, f, l) {
            ...
            function x(e) {
                if (!e) {
                    l.$setValidity("date", true);
                    return null
                } else if (angular.isDate(e)) {
                    l.$setValidity("date", true);
                    return e
                } else if (angular.isString(e)) {
                    var t = new Date(e);
                    if (isNaN(t)) {
                        l.$setValidity("date", false);
                        return undefined
                    } else {
                        l.$setValidity("date", true);
                        return t
            ...
            c.isOpen = v ? v(u) : false;
            var y = function(e) {
                if (c.isOpen && e.target !== a[0]) {
                    c.$apply(function() {
                        g(false)
                    })
                }
            ...
            var E = angular.element(w.children()[0]),
                S = {};
            if (f.datepickerOptions) {
                S = u.$eval(f.datepickerOptions);
            ...
            T(f.max, "max");
            if (f.showWeeks) {
                T(f.showWeeks, "showWeeks", "show-weeks")
            } else {
                c.showWeeks = "show-weeks" in S ? S["show-weeks"] : o.showWeeks;
    ...
    return {
        ...
        link: function(t, i, s) {
            ...
            i.bind("click", function(t) {
                ...
                if (!s && !i.hasClass("disabled") && !i.prop("disabled")) {
...
angular.module("ui.bootstrap.modal", ["ui.bootstrap.transition"]).factory("$$stackedMap", function() {
    ...
    return {
        ...
        link: function(n, r, i) {
            ...
            n.close = function(t) {
                var n = e.getTop();
                if (n && n.value.backdrop && n.value.backdrop != "static" && t.target === t.currentTarget) {
                    t.preventDefault();
                    t.stopPropagation();
...
angular.module("ui.bootstrap.pagination", []).controller("PaginationController", ["$scope", "$attrs", "$parse", "$interpolate", function(e, t, n, r) {
    ...
    this.render = function() {
        ...
        if (this.page > 0 && this.page <= e.totalPages) {
            e.pages = this.getPages(this.page, e.totalPages)
        }
    };
    e.selectPage = function(t) {
        if (!i.isActive(t) && t > 0 && t <= e.totalPages) {
            e.page = t;
            e.onSelectPage({
                page: t
            })
    ...
    return {
        ...
        link: function(n, r, i, s) {
            ...
            var o, u = s.getAttributeValue(i.boundaryLinks, t.boundaryLinks),
                ...
                f = s.getAttributeValue(i.firstText, t.firstText, true),
                l = s.getAttributeValue(i.previousText, t.previousText, true),
                c = s.getAttributeValue(i.nextText, t.nextText, true),
                h = s.getAttributeValue(i.lastText, t.lastText, true),
                p = s.getAttributeValue(i.rotate, t.rotate);
            s.init(t.itemsPerPage);
            if (i.maxSize) {
                n.$parent.$watch(e(i.maxSize), function(e) {
                    o = parseInt(e, 10);
                    s.render()
                })
            }
            s.getPages = function(e, t) {
                ...
                var r = 1,
                    i = t;
                var v = angular.isDefined(o) && o < t;
                if (v) {
                    if (p) {
                        r = Math.max(e - Math.floor(o / 2), 1);
                        i = r + o - 1;
                        if (i > t) {
                            i = t;
                            r = i - o + 1
                        ...
                        r = (Math.ceil(e / o) - 1) * o + 1;
                        i = Math.min(r + o - 1, t)
                    }
                }
                for (var m = r; m <= i; m++) {
                    var g = d(m, m, s.isActive(m), false);
                    n.push(g)
                }
                if (v && !p) {
                    if (r > 1) {
                        var y = d(r - 1, "...", false, false);
                        n.unshift(y)
                    }
                    if (i < t) {
                        var b = d(i + 1, "...", false, false);
                        n.push(b)
                    }
                }
                if (a) {
                    var w = d(e - 1, l, false, s.noPrevious());
                    n.unshift(w);
                    var E = d(e + 1, c, false, s.noNext());
                    n.push(E)
                }
                if (u) {
                    var S = d(1, f, false, s.noPrevious());
                    n.unshift(S);
                    var x = d(t, h, false, s.noNext());
                    n.push(x)
                }
                return n
            }
    ...
    return {
        ...
        link: function(t, n, r, i) {
            ...
            var s = i.getAttributeValue(r.previousText, e.previousText, true),
                o = i.getAttributeValue(r.nextText, e.nextText, true),
                u = i.getAttributeValue(r.align, e.align);
            i.init(e.itemsPerPage);
            i.getPages = function(e) {
                return [a(e - 1, s, i.noPrevious(), true, false), a(e + 1, o, i.noNext(), false, true)]
            }
        }
    }
}]);
angular.module("ui.bootstrap.tooltip", ["ui.bootstrap.position", "ui.bootstrap.bindHtml"]).provider("$tooltip", function() {
    ...
    this.$get = ["$window", "$compile", "$timeout", "$parse", "$document", "$position", "$interpolate", function(i, s, o, u, a, f, l) {
        return function(c, h, p) {
            ...
            var g = l.startSymbol();
            var y = l.endSymbol();
            var b = "<div " + m + "-popup " + 'title="' + g + "tt_title" + y + '" ' + 'content="' + g + "tt_content" + y + '" ' + 'placement="' + g + "tt_placement" + y + '" ' + 'animation="tt_animation" ' + 'is-open="tt_isOpen"' + 'compile-scope="$parent"' + ">" + "</div>";
            return {
                restrict: "EA",
                scope: true,
                compile: function(e, t) {
                    ...
                    return function(t, r, i) {
                        ...
                        var l;
                        var p;
                        var m = angular.isDefined(d.appendToBody) ? d.appendToBody : false;
                        var g = v(undefined);
                        var y = false;
                        var b = angular.isDefined(i[h + "Enable"]);
                        var w = function() {
                            var e, n, i, o;
                        ...
                        i.$observe(h + "PopupDelay", function(e) {
                            var n = parseInt(e, 10);
                            t.tt_popupDelay = !isNaN(n) ? n : d.popupDelay
                        });
                        var L = function() {
                            if (y) {
                                r.unbind(g.show, S);
...
}]).directive("popoverTemplatePopup", ["$http", "$templateCache", "$compile", "$timeout", function(e, t, n, r) {
    return {
        restrict: "EA",
        replace: true,
        scope: {
        ...
        link: function(i, s) {
            i.$watch("content", function(o) {
                ...
                e.get(o, {
                    ...
                    var t = angular.element(s[0].querySelector(".popover-content"));
                    t.children().remove();
                    t.append(n(e.data.trim())(i.compileScope()));
                    r(function() {
                        i.compileScope().$digest()
                    })
                })
            })
        }
...
angular.module("ui.bootstrap.progressbar", ["ui.bootstrap.transition"]).constant("progressConfig", {
    ...
    this.update = function(e, t, n) {
        ...
        if (u) {
            e.css("width", this.getPercentage(n) + "%");
            r(e, {
                width: i + "%"
            })
        } else {
...
angular.module("ui.bootstrap.rating", []).constant("ratingConfig", {
    ...
    e.readonly = false;
    if (t.readonly) {
        e.$parent.$watch(n(t.readonly), function(t) {
            e.readonly = !!t
        })
    }
...
angular.module("ui.bootstrap.tabs", []).controller("TabsetController", ["$scope", function(t) {
    ...
    return {
        ...
        link: function(e, t, n) {
            e.vertical = angular.isDefined(n.vertical) ? e.$parent.$eval(n.vertical) : false;
            e.justified = angular.isDefined(n.justified) ? e.$parent.$eval(n.justified) : false;
    ...
    return {
        ...
        compile: function(t, n, r) {
            return function(n, i, s, o) {
                ...
                n.disabled = false;
                if (s.disabled) {
                    n.$parent.$watch(e(s.disabled), function(e) {
                        n.disabled = !!e
                    })
                }
                n.select = function() {
    ...
    return {
        ...
        link: function(i, s, o, u) {
            function h() {
                ...
                var t = i.showMeridian ? e > 0 && e < 13 : e >= 0 && e < 24;
                if (!t) {
                    return undefined
                }
                if (i.showMeridian) {
            ...
            function S() {
                u.$setValidity("time", true);
                i.invalidHours = false;
                i.invalidMinutes = false
            }
            ...
            var l = n.hourStep;
            if (o.hourStep) {
                i.$parent.$watch(e(o.hourStep), function(e) {
                    l = parseInt(e, 10)
                })
            }
            var c = n.minuteStep;
            if (o.minuteStep) {
                i.$parent.$watch(e(o.minuteStep), function(e) {
                    c = parseInt(e, 10)
                })
            }
            i.showMeridian = n.showMeridian;
            if (o.showMeridian) {
                i.$parent.$watch(e(o.showMeridian), function(e) {
                    i.showMeridian = !!e;
                    if (u.$error.time) {
                        var t = h(),
                            n = p();
                        if (angular.isDefined(t) && angular.isDefined(n)) {
                            a.setHours(t);
                            E()
                        }
                    } else {
            ...
            var v = s.find("input"),
                m = v.eq(0),
                g = v.eq(1);
            var y = angular.isDefined(o.mousewheel) ? i.$eval(o.mousewheel) : n.mousewheel;
            if (y) {
                var b = function(e) {
                    if (e.originalEvent) {
                        e = e.originalEvent
            ...
            if (!i.readonlyInput) {
                ...
                g.bind("blur", function(e) {
                    if (!i.invalidMinutes && i.minutes < 10) {
                        i.$apply(function() {
            ...
            u.$render = function() {
                ...
                if (isNaN(e)) {
                    u.$setValidity("time", false);
                    t.error('Timepicker directive: "ng-model" value must be a Date object, a number of milliseconds since 01.01.1970 or a string representing an RFC2822 or ISO 8601 date.')
                } else {
                    if (e) {
                        a = e
                    }
...
angular.module("ui.bootstrap.typeahead", ["ui.bootstrap.position", "ui.bootstrap.bindHtml"]).factory("typeaheadParser", ["$parse", function(e) {
    ...
    return {
        ...
        link: function(a, f, l, c) {
            ...
            var p = a.$eval(l.typeaheadWaitMs) || 0;
            var d = a.$eval(l.typeaheadEditable) !== false;
            var v = t(l.typeaheadLoading).assign || angular.noop;
            var m = t(l.typeaheadOnSelect);
            var g = l.typeaheadInputFormatter ? t(l.typeaheadInputFormatter) : undefined;
            var y = l.typeaheadAppendToBody ? t(l.typeaheadAppendToBody) : false;
            var b = t(l.ngModel).assign;
            var w = o.parse(l.typeahead);
            var E;
            ...
            if (angular.isDefined(l.typeaheadTemplateUrl)) {
                S.attr("template-url", l.typeaheadTemplateUrl)
            }
            var x = a.$new();
            ...
            var N = function(e) {
                ...
                v(a, true);
                n.when(w.source(a, t)).then(function(n) {
                    if (e === c.$viewValue && E) {
                        if (n.length > 0) {
                            x.activeIdx = 0;
                            x.matches.length = 0;
            ...
            c.$parsers.unshift(function(e) {
                ...
                if (d) {
                    ...
                    if (!e) {
                        c.$setValidity("editable", true);
                        return e
                    } else {
                        c.$setValidity("editable", false);
                        return undefined
                    }
                }
            });
            ...
            f.bind("keydown", function(e) {
                ...
                if (e.which === 40) {
                    ...
                    x.activeIdx = (x.activeIdx ? x.activeIdx : x.matches.length) - 1;
                    x.$digest()
